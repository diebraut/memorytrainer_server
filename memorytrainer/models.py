...
class ExercisePackage(models.Model):
    ...
    treeNode = models.ForeignKey(TreeNode, on_delete=models.CASCADE, related_name='exercise_packages')
...
# Hilfsklasse (kein Django-Model), darf hier mitliegen
class KnowledgeTree:
    _instance = None
    ...
    def _initialize_exercise_packages(self):
        ...
        ExercisePackage.objects.create(packageName="packName_1", packageDescription="Inhalts Beschreibung etwas länger",
                                       createDate="2017-11-11", changeDate="2025-01-01", treeNode=u11)
        ExercisePackage.objects.create(packageName="packName_2", packageDescription="Inhalts Beschreibung etwas länger",
                                       createDate="2019-11-11", changeDate="2025-01-01", treeNode=u11)
